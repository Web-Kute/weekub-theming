/******/ (function () {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 883: /***/ function (module, exports, __webpack_require__) {
      ...
      (function (window, factory) {
        ...
        if (true) {
          // AMD
          !((__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(464)]),
  ...
  !(function () {
    'use strict'; // CONCATENATED MODULE: ./templates/js/Customers.js
    ...
    var customersItem = [
      {
        ...
        description:
          '<li>D\xE9veloppement des sliders produits,</li>\n                  <li>Syst\xE8me atomic design</li>\n                  <li>HTML | CSS | JavaScript / jQuery</li>\n                  <li>Bootstrap</li>',
      ...
      },
      {
        ...
        description:
          '<li>D\xE9veloppement de la modale cookies</li>\n                  <li>Responsive</li>\n                  <li>HTML | CSS / Sass | JavaScript </li>',
      ...
      },
      {
        ...
        description:
          "<li>Site carri\xE8re LVMH from scratch</li>\n                  <li>Mise en place de l'accessibilit\xE9</li>\n                  <li>HTML | CSS / Less | jQuery</li>",
      ...
      },
      {
        ...
        description:
          '<li>WordPress, template vierge</li>\n                  <li>Optimisation de la performance</li>\n                  <li>Aspect UI / UX</li>\n                  <li>S.E.O naturel</li>\n                  <li>HTML | CSS | jQuery | Bootstrap</li>',
      ...
      },
      {
        ...
        description:
          '<li>WordPress, template Astra</li>                 \n                  <li>Aspect UI / UX</li>\n                  <li>S.E.O naturel</li>\n                  <li>HTML | CSS | JavaScript</li>',
      ...
      },
      {
        ...
        description:
          '<li>Migration du site vers le CMS Jahia</li>\n                  <li>Int\xE9gration du contenu</li>',
      ...
      },
      {
        ...
        description:
          '<li>Application board traders</li>\n                  <li>D\xE9veloppement Flash</li>\n                  <li>HTML | CSS | ActionScript</li>',
      ...
      },
      {
        ...
        description:
          '<li>D\xE9veloppement WordPress</li>\n                  <li>HTML | CSS | Php</li>',
      ...
      },
      {
        ...
        description:
          '<li>D\xE9veloppement Intranet du livre blanc</li>\n                  <li>HTML | CSS | Php</li>',
      ...
      },
      {
        ...
        description:
          '<li>Int\xE9gration landing page</li>\n                  <li>HTML | CSS</li>',
    ...
    var skillItems = [
      ...
      },
      {
        ...
        title: 'Responsive',
        description:
          "<li>Un site web responsive s'adapte aux diff\xE9rentes tailles d'\xE9crans,\n                  smartphone, PC, tablettes ou TV</li>\n                  <li>Mobile First</li>\n                  <li>Compatibilit\xE9 cross-navigateur</li>",
      ...
      },
      {
        ...
        title: 'WordPress',
        description:
          '<li>D\xE9veloppement de th\xE8mes sur mesure</li>\n                  <li>Blank themes (Underscores, BlankSlate)</li>',
        icon: ['#wordpress'],
        star: '&starf;&starf;&starf;&star;&star;',
      },
    ...
    Weekub.prototype.events = function () {
      ...
      this.addEvent(this.elements.arrowUp, 'click', function () {
    ...
    Weekub.prototype.showHideMenu = function (event) {
      ...
      var isOpen = this.elements.burgerMenu.classList.contains('show');
    ...
    Weekub.prototype.navHighlighter = function () {
      ...
      this.elements.sections.forEach(function (current) {
        ...
        var itemBurgerMenu = document.querySelector(
          '.burgermenu [data-id="'.concat(current.dataset.section, '"]')
        );
        var isActive =
    ...
    Weekub.prototype.heightSizeContact = function () {
      ...
      var heights = [document.documentElement.clientHeight, window.innerHeight];
      var maxHeight = Math.max.apply(Math, heights);
      var vh = maxHeight;
      if (vh > 0) {
        var contactSectionFullHeight =
