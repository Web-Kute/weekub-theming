...
const IMAGE_URL = BASE_URL + 'c_fill,h_169,w_300/weekub/models-';
/**
...
export const customersItem = [
  {
    ...
    description: `<li>Développement des sliders produits,</li><li>Système atomic design</li><li>HTML | CSS | JavaScript / jQuery</li><li>Bootstrap</li>`,
