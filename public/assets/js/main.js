...
var customersItem = [{
  ...
  description: "<li>WordPress, th\xE8me personnalis\xE9</li>\n                  <li>Aspect UI / UX</li>\n                  <li>S.E.O naturel</li>\n                  <li>Advanced Custom Fields</li>\n                  <li>HTML | CSS | JS | PHP</li>",
...
function getSortedCustomers() {
  return [].concat(customersItem).sort(function (a, b) {
...
function Weekub() {
  ...
  var sortedCustomers = getSortedCustomers();
  this.addContent(this.elements.customerContent, sortedCustomers, this.generateCustomerHTML
...
Weekub.prototype.events = function () {
  this.addEvent(this.elements.btnSwitchTheme, 'change', this.theming.bind(this));
  this.addEvent(document, 'click', this.closeMenuOutSide.bind(this));
  this.addEvent(window, 'scroll', this.navHighlighter.bind(this));
  this.addEvent(this.elements.toggleMenu, 'click', this.showHideMenu.bind(this));
...
Weekub.prototype.navHighlighter = function () {
  ...
  this.elements.sections.forEach(function (current) {
    ...
    var isActive = scrollY > sectionTop && scrollY <= sectionTop + current.offsetHeight;
...
Weekub.prototype.addContent = function (container, items, generateHTML) {
  if (!container || !Array.isArray(items) || typeof generateHTML !== 'function') {
    return;
  }
...
Weekub.prototype.heightSizeContact = function () {
  ...
  var vh = maxHeight;
  if (vh > 0) {
    var contactSectionFullHeight = this.elements.sectionContact.getBoundingClientRect().height;
    this.elements.sectionContact.style.paddingBottom = vh - contactSectionFullHeight - footerHeight + 'px';
  }
};
document.addEventListener('DOMContentLoaded', function () {
  var text = document.querySelector('h2.animate-text');
  var cursorElement = document.querySelector('h2.animate-text::after');
  ...
  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    ...
    var textArr = ['HTML/CSS/JS', 'WordPress', 'Bootstrap 5', 'Responsive', 'Accessibilité', 'UX & UI Design', 'SEO naturel'];
    var getAnimFromIndex = function getAnimFromIndex(index) {
      return {
        duration: 1.5,
        repeat: 1,
        repeatDelay: 2.2,
